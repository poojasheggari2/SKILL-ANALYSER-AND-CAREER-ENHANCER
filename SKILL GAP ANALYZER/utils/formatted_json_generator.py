...
def split_reviews_keep_fields(input_filename, output_filename):
    ...
    for course in data:
        ...
        if isinstance(reviews, list) and reviews:
            ...
            chunks = [reviews[i:i + 10] for i in range(0, total_reviews, 10)]
...
def process_all_files(input_folder, output_folder):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith(".json"):
            ...
            split_reviews_keep_fields(input_path, output_path)

if __name__ == "__main__":
    # Set your input and output folder paths
    input_folder = "category"
    output_folder = "formatted_category"
